...
static inline nm_menu_item_t *nm_vect_item(const nm_vect_t *v,
                                           const size_t     index)
{
    return (nm_menu_item_t *)nm_vect_at(v, index);
}
static inline nm_str_t *nm_vect_item_name(const nm_vect_t * v,
                                          const size_t      index)
{
    return (nm_str_t *)nm_vect_item(v, index)->name;
}
static inline char *nm_vect_item_name_ctx(const nm_vect_t * v,
                                          const size_t      index)
{
...
static inline void nm_vect_set_item_status(nm_vect_t *v, const size_t index,
                                           const int s)
{
