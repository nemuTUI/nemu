...
static const char NM_SQL_VMS_INSERT_CLONE[] =
    ...
    "cmdappend, team, display_type, pflash, spice_agent, '%s', '%s' "
...
static const char NM_SQL_VMS_SELECT_PID_PATH[] =
    "SELECT pid_path FROM vms WHERE name='%s'";
