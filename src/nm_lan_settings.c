...
static void nm_lan_add_veth(void)
{
    ...
    set_field_type(fields[NM_FLD_LNAME], TYPE_REGEXP,
                   "^[a-zA-Z0-9_-]{1,15} *$");
    set_field_type(fields[NM_FLD_RNAME], TYPE_REGEXP,
                   "^[a-zA-Z0-9_-]{1,15} *$");
...
static void nm_lan_export_svg(const nm_vect_t *veths)
{
    ...
    set_field_type(fields[NM_SVG_FLD_TYPE], TYPE_ENUM, nm_form_svg_layer, false,
                   false);
